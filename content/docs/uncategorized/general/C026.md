---
title: AWS 도메인 구매하기
description: 1. Amazon Web Services 홈 페이지에 접속합니다. 2. 우측 상단에 콘솔에 로그인 클릭합니다. 3. 위 화면에서 루트 사용자 이메일을 사용하여 로그인 누릅니다. 4. 이메일 주소 입력하고 다음 누릅니다. 5. 비밀번호 입력하고 로그인 누릅니다. 6.
id: C026
"no": 26
order: 26
category: null
...
![AWS 도메인 구매하기 image](https://image.lemoncloud.io/50f40797-e33f-4e79-8d34-3f0192949d7d)

4. 이메일 주소 입력하고 **다음** 누릅니다.



![AWS 도메인 구매하기 image](https://image.lemoncloud.io/5b6aed2e-30c1-4c10-ab7e-965d6553aa87)
