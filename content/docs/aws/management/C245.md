...
description: AWS Organizations는 여러 AWS 계정들을 조직 단위로 통합하여 중앙 관리할 수 있도록 도와주는 AWS 서비스입니다. 개인적으로 Organizations를 처음 접하게 되면서 가장 궁금했던 부분은 "IAM과 어떤 차이가 있을까? " 였습니다.
id: C245
"no": 245
order: 245
category: aws
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/6385a8a7-cc4f-4254-ba2f-70922b1a52a0)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/812393a8-ae68-4fcb-8a0e-6a26cd614c50)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/b055c7ec-663f-4c7b-8edd-307ef964210c)



그러면 다음과 같이 조직이 바로 생성되는 것을 확인해볼 수 있습니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/09e904b0-75dd-4fe0-a641-149dbd1f813a)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/f95966de-fb3e-4a1f-9f67-daf33fcf28b0)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/cd145a44-8478-457a-8558-7463d928bffb)



그리고 세부정보들을 입력한 뒤 최종 생성해 줍니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/60c794ea-1c72-461d-9a0e-f1e892d69a0c)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/69e5cca1-8b15-4a5b-8e52-56367fdf17a2)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/d371361f-70d6-4f9e-9f26-77a0c82d6d60)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/208230f8-ccf9-434e-a7e8-870b9d0fdacf)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/18af335b-87bd-40d9-9f86-4523b96aa1f2)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/e7d94c64-8fa0-4021-b3b9-6939a5455323)



마지막으로 이동시킬 OU를 선택한 뒤 "AWS 계정 이동"을 클릭합니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/5d3a8349-f4cd-4003-8c6d-11cb38194280)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/2cd7326b-c548-4707-8486-4e39002f727f)



그리고 "서비스 제어 정책 활성화" 버튼을 클릭합니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/784ee754-02e5-4790-a187-47cb292f7cb6)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/9362a7b6-0478-40cf-bcdc-c07c31a56aef)



다음으로 "정책 생성"을 클릭합니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/85127fb7-bc34-4dcb-841d-0a12ed94b70b)

 

그리고 S3 사용에 대한 Deny 설정을 하여 정책을 생성해 줍니다.

![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/e82731e4-b866-4869-b4bf-31fe79785671)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/792f30a9-c202-4e87-8f00-3e59c1cba99e)
...
![[AWS] Organizations로 계정 관리하기 image](https://image.lemoncloud.io/e98bbf0d-11cc-40b7-bb16-b15dfb2c0ae8)
