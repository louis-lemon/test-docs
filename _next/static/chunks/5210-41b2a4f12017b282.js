"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5210],{15210:(e,t,i)=>{i.d(t,{Sy:()=>B});var r=i(12115);let o=`#version 300 es
...
}`;var u=i(95155);async function h(e){let t={},i=[];return Object.entries(e).forEach(e=>{let[r,o]=e;if("string"==typeof o){if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch(e){return!1}})(o))return void console.warn('Uniform "'.concat(r,'" has invalid URL "').concat(o,'". Skipping image loading.'));let e=new Promise((e,i)=>{let a=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch(e){return!1}})(o)&&(a.crossOrigin="anonymous"),a.onload=()=>{t[r]=a,e()},a.onerror=()=>{console.error("Could not set uniforms. Failed to load image at ".concat(o)),i()},a.src=o});i.push(e)}else t[r]=o}),await Promise.all(i),t}let c=(0,r.forwardRef)(function(e,t){let{fragmentShader:i,uniforms:o,webGlContextAttributes:a,speed:s=0,frame:l=0,minPixelRatio:c,maxPixelCount:f,...p}=e,[g,d]=(0,r.useState)(!1),m=(0,r.useRef)(null),v=(0,r.useRef)(null);(0,r.useEffect)(()=>((async()=>{let e=await h(o);m.current&&!v.current&&(v.current=new n(m.current,i,e,a,s,l,c,f),d(!0))})(),()=>{var e;null==(e=v.current)||e.dispose(),v.current=null}),[i,a]),(0,r.useEffect)(()=>{(async()=>{var e;let t=await h(o);null==(e=v.current)||e.setUniforms(t)})()},[o,g]),(0,r.useEffect)(()=>{var e;null==(e=v.current)||e.setSpeed(s)},[s,g]),(0,r.useEffect)(()=>{var e;null==(e=v.current)||e.setMaxPixelCount(f)},[f,g]),(0,r.useEffect)(()=>{var e;null==(e=v.current)||e.setMinPixelRatio(c)},[c,g]),(0,r.useEffect)(()=>{var e;null==(e=v.current)||e.setFrame(l)},[l,g]);let _=function(e){let t=r.useRef(void 0),i=r.useCallback(t=>{let i=e.map(e=>{if(null!=e){if("function"==typeof e){let i=e(t);return"function"==typeof i?i:()=>{e(null)}}return e.current=t,()=>{e.current=null}}});return()=>{i.forEach(e=>e?.())}},e);return r.useMemo(()=>e.every(e=>null==e)?null:e=>{t.current&&(t.current(),t.current=void 0),null!=e&&(t.current=i(e))},e)}([m,t]);return(0,u.jsx)("div",{ref:_,...p})});c.displayName="ShaderMount";let f=`
in vec2 v_objectUV;
in vec2 v_responsiveUV;
in vec2 v_responsiveBoxGivenSize;
in vec2 v_patternUV;
in vec2 v_imageUV;`,p={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},g={none:0,contain:1,cover:2};function d(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:v;if("string"!=typeof e)return v;let t,i,r,o=1;if(e.startsWith("#"))[t,i,r,o]=function(e){3===(e=e.replace(/^#/,"")).length&&(e=e.split("").map(e=>e+e).join("")),6===e.length&&(e+="ff");let t=parseInt(e.slice(0,2),16)/255,i=parseInt(e.slice(2,4),16)/255;return[t,i,parseInt(e.slice(4,6),16)/255,parseInt(e.slice(6,8),16)/255]}(e);else if(e.startsWith("rgb"))[t,i,r,o]=function(e){let t=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??"0")/255,parseInt(t[2]??"0")/255,parseInt(t[3]??"0")/255,void 0===t[4]?1:parseFloat(t[4])]:[0,0,0,1]}(e);else{if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),v;[t,i,r,o]=function(e){let t,i,r,[o,a,n,s]=e,l=o/360,u=a/100,h=n/100;if(0===a)t=i=r=h;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,o=h<.5?h*(1+u):h+u-h*u,a=2*h-o;t=e(a,o,l+1/3),i=e(a,o,l),r=e(a,o,l-1/3)}return[t,i,r,s]}(function(e){let t=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??"0"),parseInt(t[2]??"0"),parseInt(t[3]??"0"),void 0===t[4]?1:parseFloat(t[4])]:[0,0,0,1]}(e))}return[m(t,0,1),m(i,0,1),m(r,0,1),m(o,0,1)]}let m=(e,t,i)=>Math.min(Math.max(e,t),i),v=[0,0,0,1],_=`
...
`,E={name:"Default",params:{...p,speed:1,frame:0,colors:["#e0eaff","#241d9a","#f75092","#9f50d3"],distortion:.8,swirl:.1}},B=(0,r.memo)(function({speed:e=E.params.speed,frame:t=E.params.frame,colors:i=E.params.colors,distortion:r=E.params.distortion,swirl:o=E.params.swirl,fit:a=E.params.fit,rotation:n=E.params.rotation,scale:s=E.params.scale,originX:l=E.params.originX,originY:h=E.params.originY,offsetX:f=E.params.offsetX,offsetY:p=E.params.offsetY,worldWidth:m=E.params.worldWidth,worldHeight:v=E.params.worldHeight,..._}){let x={u_colors:i.map(d),u_colorsCount:i.length,u_distortion:r,u_swirl:o,u_fit:g[a],u_rotation:n,u_scale:s,u_offsetX:f,u_offsetY:p,u_originX:l,u_originY:h,u_worldWidth:m,u_worldHeight:v};return(0,u.jsx)(c,{..._,speed:e,frame:t,fragmentShader:b,uniforms:x})},function(e,t){for(let i in e){if("colors"===i){let i=Array.isArray(e.colors),r=Array.isArray(t.colors);if(!i||!r){if(!1===Object.is(e.colors,t.colors))return!1;continue}if(e.colors?.length!==t.colors?.length||!e.colors?.every((e,i)=>e===t.colors?.[i]))return!1;continue}if(!1===Object.is(e[i],t[i]))return!1}return!0})}}]);